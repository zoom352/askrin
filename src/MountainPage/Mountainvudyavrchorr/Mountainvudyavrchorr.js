...
const MountainvudyavrchorrPage = () => {
...
<div className={s.elipse}>
        ...
        {openscreen ?<div className={s.content}>
            <h1 className={s.wraph}>вудъяврчорр</h1>
...
<img className={s.traingleEmpty6} 
    ...
    { elipse ? <img className={s.image} src={Mountainvudyavrchorr} alt='Mountainvudyavrchorr'/>
      : <img className={s.image} src={ckokiPage} 
      alt='ckokiPage'/>}
    </div>
}


export default MountainvudyavrchorrPage;